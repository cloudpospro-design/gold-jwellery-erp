...
from routes import auth_routes, user_routes, inventory_routes, sales_routes, purchase_routes, gst_routes, gold_rates_routes, analytics_routes, notifications_routes
